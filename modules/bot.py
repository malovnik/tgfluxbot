...
def main():
    ...
    try:
        ...
        # Регистрируем ConversationHandler для обработки пользовательских запросов
        user_request_conv_handler = ConversationHandler(
            entry_points=[
        ...
        application.add_handler(user_request_conv_handler)
