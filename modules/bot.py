...
from modules.config import (
    ...
    SETTING_AUTO_CONFIRM_PROMPT, SETTING_KEYWORD
)
from modules.handlers import (
    ...
    auto_confirm_prompt_handler, keyword_handler
)
    ...
    try:
        ...
        settings_conv_handler = ConversationHandler(
            ...
            states={
                ...
                SETTING_KEYWORD: [MessageHandler(filters.TEXT & ~filters.COMMAND, keyword_handler)],
